...
// SVG social icons since lucide-react v0.400+ removed Facebook/Instagram/Youtube
...
export async function Footer() {
  ...
  const activeLocalities = areasList.length > 0 
    ? areasList.slice(0, 4).map(a => ({ slug: a.slug, label: a.name }))
    : [
