...
export function usePropertyForm() {
    ...
    const seedFromRecord = useCallback((record) => {
        ...
        setForm({
            ...
            // Seed detail fields
            bhk: String(d.bhk ?? ""),
            minBhk: String(d.minBhk ?? ""),
            maxBhk: String(d.maxBhk ?? ""),
            ...
            minCarpetArea: String(d.minCarpetArea ?? ""),
            maxCarpetArea: String(d.maxCarpetArea ?? ""),
            builtUpArea: String(d.builtUpArea ?? ""),
            minBuiltUpArea: String(d.minBuiltUpArea ?? ""),
            maxBuiltUpArea: String(d.maxBuiltUpArea ?? ""),
            superBuiltUpArea: String(d.superBuiltUpArea ?? ""),
            minSuperBuiltUpArea: String(d.minSuperBuiltUpArea ?? ""),
            maxSuperBuiltUpArea: String(d.maxSuperBuiltUpArea ?? ""),
            minSqft: String(d.minSqft ?? ""),
            maxSqft: String(d.maxSqft ?? ""),
            minPlotArea: String(d.minPlotArea ?? ""),
            maxPlotArea: String(d.maxPlotArea ?? ""),
            minPlotAreaSqFt: String(d.minPlotAreaSqFt ?? ""),
            maxPlotAreaSqFt: String(d.maxPlotAreaSqFt ?? ""),
            minShowroomArea: String(d.minShowroomArea ?? ""),
            maxShowroomArea: String(d.maxShowroomArea ?? ""),
            minWarehouseArea: String(d.minWarehouseArea ?? ""),
            maxWarehouseArea: String(d.maxWarehouseArea ?? ""),
