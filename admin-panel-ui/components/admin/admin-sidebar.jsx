...
const menuItems = [
  ...
  { icon: MapPin,          label: "Areas",          href: "/admin/areas",         module: null            },
  { icon: BookOpen,        label: "Blogs",          href: "/admin/blogs",         module: null            },
  { icon: Tag,             label: "Keywords",       href: "/admin/keywords",      module: null            },
