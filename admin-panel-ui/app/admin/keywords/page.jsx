...
export default function KeywordsAdminPage() {
  ...
  const { canWrite, canDelete } = usePermission("keywords");
  ...
  return (
    <PermissionGate module="keywords" action="read" fallback={<Unauthorized />}>
        ...
        >
          <div className="flex items-center gap-2 flex-wrap">
            <Button
              ...
              disabled={suggestLoading || !canWrite}
            >
