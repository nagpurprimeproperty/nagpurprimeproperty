        ...
        <Card>
          ...
          <CardContent className="grid gap-4 sm:grid-cols-2">
            ...
            <Field label="Slug">
              ...
              <p className="mt-1 text-xs text-muted-foreground">⚠ Changing the slug will break existing links to this area.</p>
            </Field>
          ...
          <CardContent className="space-y-6">
            <div className="space-y-1.5">
              ...
              <RichTextEditor
                ...
                placeholder="Write an overview of this area — highlight key features, landmark projects, and why people choose to live here."
                minHeight={200}
              />
            </div>
            ...
            <Field label="Schools (comma-separated)">
              <Textarea rows={2} value={form.schools} onChange={(e) => set("schools", e.target.value)} placeholder="e.g. City Pride School, DPS, Inventure Academy" />
              <p className="mt-1 text-xs text-muted-foreground">Separate school names with commas.</p>
            </Field>
            ...
            <Field label="Hospitals (comma-separated)">
              ...
              <p className="mt-1 text-xs text-muted-foreground">Separate hospital names with commas.</p>
            </Field>
