...
import { ShieldCheck, Lock, EyeOff, RefreshCw } from 'lucide-react-native';
...
import { usePrivacyPolicy } from '@/hooks/useSupportAndLegalHooks';

// ─── Helpers ──────────────────────────────────────────────────────────────────

/**
 * Strips HTML tags and decodes common HTML entities from the API response.
 * The API returns content as an HTML string; we render it as plain text.
 */
function parseHtmlSections(html: string): { title: string; content: string }[] {
  // Remove outer wrapper tags and split by <h3>
  ...
  return (
    <ScreenWrapper>
      <ScreenHeader
        ...
        rightIcon={<Lock size={18} color={colors.primary} />}
      />
          ...
          <>
            ...
            >
              ...
              <View className="flex-row items-center mb-2">
                <EyeOff size={14} color={colors.primary} strokeWidth={3} />
              ...
              <Text className="text-white font-bold text-[13px] leading-5">
                We value your privacy. We never sell your data to third parties.
                Your information is shared only with brokers you choose to contact.
              </Text>
            </Animated.View>
