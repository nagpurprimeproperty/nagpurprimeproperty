...
const detailsSchema = new mongoose.Schema({
  ...
  minBhk:              { type: Number, min: [BHK_MIN_LENGTH_LIMIT, BHK_MIN_LENGTH_LIMIT_MESSAGE], max: [BHK_MAX_LENGTH_LIMIT, BHK_MAX_LENGTH_LIMIT_MESSAGE] },
  maxBhk:              { type: Number, min: [BHK_MIN_LENGTH_LIMIT, BHK_MIN_LENGTH_LIMIT_MESSAGE], max: [BHK_MAX_LENGTH_LIMIT, BHK_MAX_LENGTH_LIMIT_MESSAGE] },
  ...
  minCarpetArea:       { type: Number, min: [CARPET_AREA_MIN_LENGTH_LIMIT, CARPET_AREA_MIN_LENGTH_LIMIT_MESSAGE] },
  maxCarpetArea:       { type: Number, min: [CARPET_AREA_MIN_LENGTH_LIMIT, CARPET_AREA_MIN_LENGTH_LIMIT_MESSAGE] },
  builtUpArea:         { type: Number, min: [BUILT_UP_AREA_MIN_LENGTH_limit, BUILT_UP_AREA_MIN_LENGTH_limit_MESSAGE] },
  minBuiltUpArea:      { type: Number, min: [BUILT_UP_AREA_MIN_LENGTH_limit, BUILT_UP_AREA_MIN_LENGTH_limit_MESSAGE] },
  maxBuiltUpArea:      { type: Number, min: [BUILT_UP_AREA_MIN_LENGTH_limit, BUILT_UP_AREA_MIN_LENGTH_limit_MESSAGE] },
  superBuiltUpArea:    { type: Number, min: [SUPER_BUILT_UP_AREA_MIN_LENGTH_limit, SUPER_BUILT_UP_AREA_MIN_LENGTH_limit_MESSAGE] },
  minSuperBuiltUpArea: { type: Number, min: [SUPER_BUILT_UP_AREA_MIN_LENGTH_limit, SUPER_BUILT_UP_AREA_MIN_LENGTH_limit_MESSAGE] },
  maxSuperBuiltUpArea: { type: Number, min: [SUPER_BUILT_UP_AREA_MIN_LENGTH_limit, SUPER_BUILT_UP_AREA_MIN_LENGTH_limit_MESSAGE] },
  minSqft:             { type: Number, min: 1 },
  maxSqft:             { type: Number, min: 1 },
  minPlotArea:         { type: Number, min: 1 },
  maxPlotArea:         { type: Number, min: 1 },
  minPlotAreaSqFt:     { type: Number, min: 1 },
  maxPlotAreaSqFt:     { type: Number, min: 1 },
  minShowroomArea:     { type: Number, min: 1 },
  maxShowroomArea:     { type: Number, min: 1 },
  minWarehouseArea:    { type: Number, min: 1 },
  maxWarehouseArea:    { type: Number, min: 1 },
...
const propertySchema = new mongoose.Schema(
  {
    ...
    propertyListedBy: {
      ...
      enum: { values:  PROPERTY_LISTED_BY_OPTIONS, message: PROPERTY_LISTED_BY_OPTIONS_MESSAGE },
    },
    description: {
      type: String,
